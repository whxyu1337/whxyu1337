...
export async function fetch_activities(username) {
 ...
 const actionIcon = (name, alt) => `<a href="https://github.com/whxyu1337Bot" title="${alt}"><img alt="${alt}" src="https://github.com/${username}/${username}/raw/master/src/images/icons/${name}.png" align="top" height="18"></a>`;
